...
Use the existing domain README structure as the guide — each domain's README documents its own layout and conventions.
...
**Flag:**
- **Stale timelines**: Active projects with no timeline entries in the last 30 days
...
**Don't:**
- Generate timeline entries yourself — that's the changelog awareness rule's job (see [communication.md](../communication.md))
